...
const translations = {
  id: {
    ...
    "resubmit.clickToUploadKtp": "Klik untuk upload foto KTP",
    ...
    "plants.totalAmount": "Total Pembayaran",
    "plants.remainingPayment": "Sisa Pembayaran",
    ...
    "payments.stats.paymentValue": "Simpanan Wajib",
    ...
    "paymentMethod.onlinePaymentDescription": "Bayar dengan berbagai metode digital",
    "paymentMethod.automaticallyVerified": "✨ Langsung terverifikasi otomatis",
    "paymentMethod.availableMethods": "Metode yang tersedia:",
    "paymentMethod.virtualAccount": "Virtual Account (BCA, BNI, Mandiri, BRI, Permata)",
    "paymentMethod.ewallet": "E-Wallet (GoPay, QRIS, ShopeePay)",
    "paymentMethod.creditDebit": "Kartu Kredit / Debit",
    "paymentMethod.indomaret": "Indomaret & Alfamart",
    "paymentMethod.processing": "Memproses...",
    "paymentMethod.continueOnline": "Lanjutkan Pembayaran Online",
    "paymentMethod.bcaTransfer": "Transfer Bank BCA",
    "paymentMethod.bcaTransferDescription": "Transfer manual ke rekening BCA",
    "paymentMethod.needsVerification": "⏱️ Perlu verifikasi tim finance (1-2 hari kerja)",
    "paymentMethod.steps": "Langkah-langkah:",
    "paymentMethod.step1": "Transfer ke rekening BCA yang diberikan",
    "paymentMethod.step2": "Upload bukti transfer di halaman Pembayaran",
    "paymentMethod.step3": "Tim finance akan verifikasi pembayaran Anda",
    "paymentMethod.step4": "Pembayaran disetujui",
    "paymentMethod.continueBCA": "Lanjutkan Transfer BCA",
    "paymentMethod.bcaAccount": "Rekening BCA",
    "paymentMethod.transferToAccount": "Transfer ke rekening di bawah ini",
    "paymentMethod.bankName": "Nama Bank",
    "paymentMethod.accountNumber": "Nomor Rekening",
    "paymentMethod.accountHolder": "Atas Nama",
    "paymentMethod.importantInstructions": "Instruksi Penting",
    "paymentMethod.instruction1": "Lakukan transfer ke rekening BCA di atas",
    "paymentMethod.instruction2": "Setelah transfer, upload bukti pembayaran di menu Pembayaran",
    "paymentMethod.instruction3": "Tim finance akan memverifikasi dalam 1-2 hari kerja",
    "paymentMethod.instruction4": "Anda akan menerima notifikasi email setelah pembayaran disetujui",
    "paymentMethod.iUnderstandContinue": "Saya Mengerti, Lanjutkan",
  ...
  en: {
    ...
    "resubmit.clickToUploadKtp": "Click to upload ID card photo",
    ...
    "plants.totalAmount": "Total Payment",
    "plants.remainingPayment": "Remaining Payment",
    ...
    "payments.stats.paymentValue": "Required Savings",
    ...
    "paymentMethod.onlinePaymentDescription": "Pay with various digital methods",
    "paymentMethod.automaticallyVerified": "✨ Automatically verified immediately",
    "paymentMethod.availableMethods": "Available methods:",
    "paymentMethod.virtualAccount": "Virtual Account (BCA, BNI, Mandiri, BRI, Permata)",
    "paymentMethod.ewallet": "E-Wallet (GoPay, QRIS, ShopeePay)",
    "paymentMethod.creditDebit": "Credit / Debit Card",
    "paymentMethod.indomaret": "Indomaret & Alfamart",
    "paymentMethod.processing": "Processing...",
    "paymentMethod.continueOnline": "Continue Online Payment",
    "paymentMethod.bcaTransfer": "BCA Bank Transfer",
    "paymentMethod.bcaTransferDescription": "Manual transfer to BCA account",
    "paymentMethod.needsVerification": "⏱️ Requires finance team verification (1-2 business days)",
    "paymentMethod.steps": "Steps:",
    "paymentMethod.step1": "Transfer to the provided BCA account",
    "paymentMethod.step2": "Upload transfer proof on the Payment page",
    "paymentMethod.step3": "Finance team will verify your payment",
    "paymentMethod.step4": "Payment approved",
    "paymentMethod.continueBCA": "Continue BCA Transfer",
    "paymentMethod.bcaAccount": "BCA Account",
    "paymentMethod.transferToAccount": "Transfer to the account below",
    "paymentMethod.bankName": "Bank Name",
    "paymentMethod.accountNumber": "Account Number",
    "paymentMethod.accountHolder": "Account Holder",
    "paymentMethod.importantInstructions": "Important Instructions",
    "paymentMethod.instruction1": "Transfer to the BCA account above",
    "paymentMethod.instruction2": "After transfer, upload payment proof on the Payment menu",
    "paymentMethod.instruction3": "Finance team will verify within 1-2 business days",
    "paymentMethod.instruction4": "You will receive an email notification after payment is approved",
    "paymentMethod.iUnderstandContinue": "I Understand, Continue",
