...
const translations = {
  id: {
    ...
    "plants.perMonth": "/bulan",
    "plants.payDirectly": "Bayar Langsung",
    "plants.processing": "Processing...",
    ...
    "plants.profitTitle": "Pendapatan / Keuntungan Bersih",
    ...
    "payments.retry.title": "Ajukan Ulang Kontrak",
    ...
    "payments.retry.maxAttemptsReached": "Maksimal percobaan pengajuan ulang telah tercapai (3 kali)",
    "payments.retry.contactAdmin": "Silakan hubungi admin untuk bantuan lebih lanjut",
    "payments.retry.instructionsTitle": "Instruksi Tanda Tangan Ulang",
    "payments.retry.instruction1": "Buat tanda tangan Anda di area yang disediakan",
    "payments.retry.instruction2": "Pastikan tanda tangan jelas dan sesuai dengan identitas Anda",
    "payments.retry.instruction3": "Tanda tangan yang sama dengan pengajuan sebelumnya lebih direkomendasikan",
    "payments.retry.instruction4": "Kontrak akan direview ulang oleh admin setelah pengajuan",
    "payments.retry.signatureLabel": "Tanda Tangan Digital",
    "payments.retry.cancel": "Batal",
    "payments.retry.submit": "Ajukan Ulang",
    "payments.retry.submitting": "Mengajukan...",
    "payments.retry.signatureRequired": "Tanda Tangan Diperlukan",
    "payments.retry.signatureRequiredMessage": "Silakan buat tanda tangan Anda",
    "payments.retry.error": "Kesalahan",
    "payments.retry.errorMessage": "Terjadi kesalahan saat mengajukan ulang kontrak",
    "payments.contract.notSigned": "Kontrak Belum Ditandatangani",
    "payments.contract.notSignedMessage": "Anda perlu menandatangani kontrak terlebih dahulu sebelum melakukan pembayaran.",
    "payments.contract.signHere": "Tandatangani di sini",
    "payments.contract.rejectedPermanent": "Kontrak Ditolak Permanen",
    "payments.contract.rejectedPermanentMessage": "Maksimal percobaan kontrak telah tercapai ({maxAttempts}x). Silakan hubungi admin untuk bantuan lebih lanjut.",
    "payments.contract.attemptsCount": "Percobaan: {current}/{max}",
    "payments.contract.needsReview": "Kontrak Memerlukan Review",
    "payments.contract.needsReviewMessage": "Percobaan kontrak: {current}/{max}. Silakan hubungi admin untuk bantuan.",
    "payments.contract.rejectedByAdmin": "Kontrak Ditolak Admin",
    "payments.contract.rejectedByAdminMessage": "Anda dapat mengajukan ulang kontrak dengan menandatangani ulang. Percobaan: {current}/{max}",
    "payments.contract.resubmit": "Ajukan Ulang",
    "payments.contract.download": "Download",

    // Signature Input
    "signature.drawSignature": "Gambar Tanda Tangan",
    "signature.uploadImage": "Upload Gambar",
    "signature.drawInstructions": "Gambar tanda tangan Anda di area di atas",
    "signature.uploadedSuccessfully": "✓ Gambar tanda tangan berhasil diupload",
    "signature.clickToUpload": "Klik untuk upload gambar tanda tangan",
    "signature.supportedFormats": "Mendukung PNG, JPG, JPEG (Max 5MB)",
    "signature.clear": "Hapus",
    "signature.helperCanvas": "Gunakan mouse atau touch untuk menggambar tanda tangan Anda",
    "signature.helperUpload": "Upload gambar tanda tangan yang sudah ada (foto tanda tangan di kertas, dll)",
    "signature.errorInvalidFile": "Harap pilih file gambar (PNG, JPG, dll)",
    "signature.errorFileTooLarge": "Ukuran file harus kurang dari 5MB",
    "signature.uploadedImageFileName": "{fileName}",
    ...
    "profile.accountMustBeVerified": "Akun Anda harus diverifikasi oleh admin sebelum dapat menghasilkan kartu anggota.",
    ...
    "cicilan.referralCodeFormat": "Kode referral 6 karakter huruf kapital dan angka",
    "cicilan.orderConfirmation": "Konfirmasi Pesanan",
    "cicilan.orderConfirmationMessage": 'Dengan menekan "Lanjutkan", kontrak akan dibuat dan Anda akan diarahkan ke halaman penandatanganan kontrak.',
    ...
    "cicilan.invalidReferralCodeMessage": "Kode referral harus 6 karakter huruf kapital dan angka",
    "cicilan.contractCreated": "Kontrak Berhasil Dibuat!",
    "cicilan.contractCreatedMessage": "Kontrak {contractNumber} telah dibuat. Anda akan diarahkan untuk menandatangani kontrak.",
    "cicilan.contractError": "Gagal Membuat Kontrak",
    "cicilan.error": "Error",
    "cicilan.errorCreatingContract": "Terjadi kesalahan saat membuat kontrak",
    "cicilan.errorPreparingContract": "Terjadi kesalahan saat menyiapkan kontrak",
  ...
  en: {
    ...
    "plants.profitTitle": "Revenue / Net Profit",
    "plants.profitPerYear": "/year",
    "plants.monthly": "Monthly",
    "plants.weekly": "Weekly",
    "plants.daily": "Daily",
    "plants.profitDisclaimer":
      "*Investment profit calculation simulation after deducting other costs",
    ...
    "payments.retry.title": "Resubmit Contract",
    "payments.retry.resubmissionStatus": "Resubmission Status",
    "payments.retry.attempts": "Attempts:",
    "payments.retry.of": "of",
    "payments.retry.lastRejectionReason": "Last rejection reason:",
    "payments.retry.adminNotes": "Admin Notes:",
    "payments.retry.maxAttemptsReached": "Maximum resubmission attempts reached (3 times)",
    "payments.retry.contactAdmin": "Please contact admin for further assistance",
    "payments.retry.instructionsTitle": "Re-Signature Instructions",
    "payments.retry.instruction1": "Create your signature in the provided area",
    "payments.retry.instruction2": "Make sure the signature is clear and matches your identity",
    "payments.retry.instruction3": "Same signature as previous submission is recommended",
    "payments.retry.instruction4": "Contract will be reviewed again by admin after submission",
    "payments.retry.signatureLabel": "Digital Signature",
    "payments.retry.cancel": "Cancel",
    "payments.retry.submit": "Resubmit",
    "payments.retry.submitting": "Submitting...",
    "payments.retry.signatureRequired": "Signature Required",
    "payments.retry.signatureRequiredMessage": "Please create your signature",
    "payments.retry.error": "Error",
    "payments.retry.errorMessage": "An error occurred while resubmitting the contract",
    "payments.contract.notSigned": "Contract Not Signed",
    "payments.contract.notSignedMessage": "You need to sign the contract before making payment.",
    "payments.contract.signHere": "Sign here",
    "payments.contract.rejectedPermanent": "Contract Permanently Rejected",
    "payments.contract.rejectedPermanentMessage": "Maximum contract attempts reached ({maxAttempts}x). Please contact admin for further assistance.",
    "payments.contract.attemptsCount": "Attempts: {current}/{max}",
    "payments.contract.needsReview": "Contract Needs Review",
    "payments.contract.needsReviewMessage": "Contract attempts: {current}/{max}. Please contact admin for assistance.",
    "payments.contract.rejectedByAdmin": "Contract Rejected by Admin",
    "payments.contract.rejectedByAdminMessage": "You can resubmit the contract by signing again. Attempts: {current}/{max}",
    "payments.contract.resubmit": "Resubmit",
    "payments.contract.download": "Download",

    // Signature Input
    "signature.drawSignature": "Draw Signature",
    "signature.uploadImage": "Upload Image",
    "signature.drawInstructions": "Draw your signature in the area above",
    "signature.uploadedSuccessfully": "✓ Signature image uploaded successfully",
    "signature.clickToUpload": "Click to upload signature image",
    "signature.supportedFormats": "Supports PNG, JPG, JPEG (Max 5MB)",
    "signature.clear": "Clear",
    "signature.helperCanvas": "Use mouse or touch to draw your signature",
    "signature.helperUpload": "Upload an existing signature image (photo of signature on paper, etc.)",
    "signature.errorInvalidFile": "Please select an image file (PNG, JPG, etc.)",
    "signature.errorFileTooLarge": "File size must be less than 5MB",
    "signature.uploadedImageFileName": "{fileName}",
    ...
    "profile.accountMustBeVerified": "Your account must be verified by admin before you can generate a member card.",
    ...
    "cicilan.referralCodeFormat": "Referral code must be 6 characters of capital letters and numbers",
    "cicilan.orderConfirmation": "Order Confirmation",
    "cicilan.orderConfirmationMessage": 'By pressing "Continue", the contract will be created and you will be directed to the contract signing page.',
    "cicilan.back": "Back",
    "cicilan.continue": "Continue",
    "cicilan.creatingContract": "Creating Contract...",
    "cicilan.invalidReferralCode": "Invalid Referral Code",
    "cicilan.invalidReferralCodeMessage": "Referral code must be 6 characters of capital letters and numbers",
    "cicilan.contractCreated": "Contract Successfully Created!",
    "cicilan.contractCreatedMessage": "Contract {contractNumber} has been created. You will be directed to sign the contract.",
    "cicilan.contractError": "Failed to Create Contract",
    "cicilan.error": "Error",
    "cicilan.errorCreatingContract": "An error occurred while creating the contract",
    "cicilan.errorPreparingContract": "An error occurred while preparing the contract",
