        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="relative w-12 h-12 rounded-xl overflow-hidden shadow-lg bg-primary">
              <Image
              src="/images/koperasi-logo.jpg"   // pastikan file ada di public/images
    alt="Logo Koperasi"
    fill
    sizes="48px"                       // ukuran visual kotak (12 * 4px = 48px)
    className="object-cover"           // cover = isi penuh, crop bila perlu
    priority
          />
          </div>
              <div>
                <h1 className="text-2xl font-bold text-card-foreground">Koperasi Bintang Merah Sejahtera</h1>
