            ...
            <CardContent className="p-4 sm:p-6 h-full">
              <div className="flex flex-col h-full justify-between">
                <div className="flex-1 min-h-0">
                  ...
                  <p className={`text-base sm:text-lg lg:text-xl xl:text-2xl font-bold ${daily.net >= 0 ? "text-green-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"} break-all leading-tight transition-colors duration-300`}>
                    {fmtIDR(daily.net)}
                  </p>
                </div>
                <div className="flex justify-end mt-3 sm:mt-4">
                  <div className={`${daily.net >= 0 ? "bg-green-500/10 dark:bg-green-900/30" : "bg-red-500/10 dark:bg-red-900/30"} p-2 sm:p-3 rounded-xl sm:rounded-2xl flex-shrink-0 transition-colors duration-300`}>
                    <DollarSign className={`${daily.net >= 0 ? "text-green-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"} w-5 h-5`} />
                  </div>
                </div>
              </div>
            </CardContent>
                      ...
                      {daily.transactions.map((t, i) => (
                        <tr key={i} className={`border-b border-[#324D3E]/5 dark:border-gray-700 ${i % 2 === 0 ? "bg-white/40 dark:bg-gray-800/40" : "bg-[#324D3E]/5 dark:bg-gray-700/50"} transition-colors duration-300`}>
                          <td className="py-2 sm:py-3 px-2 sm:px-4">
                            <span className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs font-medium ${t.type === "income" ? "bg-green-500/10 dark:bg-green-900/30 text-green-600 dark:text-emerald-400" : "bg-red-500/10 dark:bg-red-900/30 text-red-600 dark:text-red-400"} transition-colors duration-300`}>
                          ...
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-[#889063] dark:text-gray-200 text-xs sm:text-sm break-words transition-colors duration-300">
                            {t.plantName}
                          </td>
                          <td className={`py-2 sm:py-3 px-2 sm:px-4 text-right font-semibold text-xs sm:text-sm ${t.type === "income" ? "text-green-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"} transition-colors duration-300`}>
                            {fmtIDR(t.amount)}
                          </td>
                        </tr>
                      ))}
