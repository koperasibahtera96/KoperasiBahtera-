    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container max-w-2xl mx-auto px-4 py-12">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Pembayaran Gagal</h1>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-red-600 font-semibold">
                    {orderDetails.transaction_status === 'deny' ? 'Ditolak' : 
                     orderDetails.transaction_status === 'cancel' ? 'Dibatalkan' :
                     orderDetails.transaction_status === 'expire' ? 'Kedaluwarsa' :
          ...
          <div className="mt-8 p-4 bg-yellow-50 rounded-lg">
            <h4 className="font-semibold text-yellow-800 mb-2">Kemungkinan Penyebab:</h4>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              💡 <strong>Tips:</strong> Pastikan informasi kartu benar, saldo mencukupi, 
              dan koneksi internet stabil sebelum mencoba lagi.
            </p>
          </div>
        </div>
      </div>
