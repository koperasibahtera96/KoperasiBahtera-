    ...
    return (
      <FinanceSidebar>
        <div className="p-8 text-center">
          ...
          <p className="text-[#889063] font-[family-name:var(--font-poppins)]">
      ...
      <div className="space-y-6 px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-[#324D3E] font-[family-name:var(--font-poppins)]">
              Detail Investor
            </h1>
            <p className="text-[#889063] mt-2 text-sm sm:text-base">
              Kelola pembayaran manual BCA dari {investorDetail.userInfo.fullName}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#324D3E]/10 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-xl sm:text-2xl font-bold text-[#324D3E] font-[family-name:var(--font-poppins)] truncate">
                {investorDetail.userInfo.fullName}
              </h2>
              <p className="text-[#889063] text-sm sm:text-base truncate">
                {investorDetail.userInfo.email}
              </p>
              {investorDetail.userInfo.userCode && (
                <p className="text-sm text-[#4C3D19] font-medium">
                  No Anggota: {investorDetail.userInfo.userCode}
                </p>
              )}
              <p className="text-sm text-[#889063]/70">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-gradient-to-r from-[#324D3E]/5 to-[#324D3E]/10 p-3 sm:p-4 rounded-xl border border-[#324D3E]/10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-[#324D3E]">
            ...
            <div className="bg-gradient-to-r from-[#889063]/5 to-[#889063]/10 p-3 sm:p-4 rounded-xl border border-[#889063]/10">
              ...
              <div className="w-full bg-[#324D3E]/10 rounded-full h-2 sm:h-3">
                <div
        ...
        <div className="space-y-6">
          {investorDetail.cicilanGroups.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-lg border border-[#324D3E]/10 p-8 text-center">
              <div className="text-[#889063] text-4xl mb-4">💳</div>
              <h3 className="text-lg font-semibold text-[#324D3E] mb-2 font-[family-name:var(--font-poppins)]">
            ...
            investorDetail.cicilanGroups
              ...
              <div
                ...
                className="bg-white rounded-2xl shadow-lg border border-[#324D3E]/10 p-4 sm:p-6"
              >
                {/* Group Header */}
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4 mb-6">
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-[#324D3E] font-[family-name:var(--font-poppins)] flex items-center gap-2">
                      {group.productName}
                      {group.isFullPayment ? (
                    ...
                    <p className="text-xs sm:text-sm text-[#889063] break-all">
                        ...
                        <div
                          ...
                          className={`border-2 rounded-xl p-3 sm:p-4 transition-all duration-300 hover:shadow-md flex flex-col ${
                            effectiveStatus === "approved"
                              ? "bg-gradient-to-r from-[#4C3D19]/5 to-[#4C3D19]/10 border-[#4C3D19]/20"
                          ...
                          <div className="mt-auto space-y-2">
                            ...
                            {(effectiveStatus === "pending" ||
                              ...
                              <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 bg-green-600 text-white text-xs sm:text-sm rounded-xl hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-semibold font-[family-name:var(--font-poppins)]"
                              >
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="bg-gradient-to-r from-[#324D3E]/10 to-[#4C3D19]/10 p-3 sm:p-4 rounded-2xl mb-4 sm:mb-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
              <div>
                ...
                <div className="font-semibold text-[#324D3E] font-poppins">
              ...
              <div>
                ...
                <div className="font-semibold text-[#324D3E] font-poppins text-sm">
                  {installment.dueDate
                    ? formatDate(installment.dueDate)
                    : "Belum ditentukan"}
                </div>
              ...
              <div>
                ...
                <div className="font-medium text-xs text-[#4C3D19] font-poppins break-all">
          ...
          {installment.proofImageUrl && (
            <div className="mb-4 sm:mb-6">
              <h4 className="font-semibold text-[#324D3E] mb-2 sm:mb-3 font-poppins">
                Bukti Pembayaran
              </h4>
          ...
          {installment.proofDescription && (
            <div className="mb-4 sm:mb-6">
              <h4 className="font-semibold text-[#324D3E] mb-2 font-poppins">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            <textarea
              ...
              className="w-full border border-gray-300 rounded-xl p-2 sm:p-3 h-20 sm:h-24 font-poppins focus:border-[#324D3E] focus:ring-1 focus:ring-[#324D3E] bg-white/80 text-sm sm:text-base text-gray-800"
