...
export default function LandingFooter() {
  return (
    <footer className="bg-[#2D3B30] text-white py-12 sm:py-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-4 font-[family-name:var(--font-poppins)]">
              Navigasi
            </h4>
            <ul className="space-y-2 text-gray-300">
              <li><a href="#beranda" className="hover:text-white transition-colors">Beranda</a></li>
              <li><a href="#investasi" className="hover:text-white transition-colors">Investasi</a></li>
