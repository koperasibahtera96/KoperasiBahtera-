    ...
    <section id="investasi" className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1416879595882-3373a0480b5b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80)",
          }}
        />
      ...
      <div className="relative container-centered">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Kami menyediakan berbagai paket investasi tanaman yang disesuaikan
            dengan kebutuhan dan kemampuan finansial Anda. Semua paket
            dilengkapi dengan
            <strong className="text-red-600"> jaminan hasil 100%</strong> dan
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`group ${plan.popular ? "lg:-mt-6 lg:mb-6" : ""}`}
            >
              <div
                className={`bg-white rounded-lg p-8 lg:p-10 transition-all duration-300 group-hover:scale-102 ${
                  plan.popular
              ...
              >
                ...
                <div className="text-center mb-8">
                  <div
                    className={`inline-flex items-center gap-2 px-4 py-2 rounded-md text-sm font-semibold mb-4 ${
                      plan.popular
                ...
                <div className="flex justify-between items-center mb-8 p-4 bg-gray-50 rounded-lg">
                  ...
                  <span
                    className={`font-bold px-3 py-1 rounded-md text-sm ${
                      plan.riskLevel === "Rendah"
                        ? "bg-green-100 text-green-700"
                        : plan.riskLevel === "Sedang"
        ...
        <div id="manfaat" className="bg-gray-50 rounded-2xl p-8 lg:p-12">
          <div className="text-center mb-12">
            <h3 className="heading-secondary mb-4">
              Alasan Berinvestasi dengan Kami
            </h3>
            <p className="text-muted max-w-2xl mx-auto">
              Investasi hijau yang memberikan keuntungan finansial sekaligus
              berkontribusi pada kelestarian lingkungan dan kesejahteraan
              masyarakat.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="flex flex-col items-start gap-4 p-6 bg-white rounded-xl"
              >
            ...
            <div className="text-center">
              ...
              <p className="text-xl lg:text-2xl text-emerald-100 mb-10 max-w-3xl mx-auto leading-relaxed">
                <strong className="text-white">
                  &quot;Bersama membangun masa depan hijau dan berkontribusi
