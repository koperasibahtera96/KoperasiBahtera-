...
export function FinanceSidebar({ children }: FinanceSidebarProps) {
  ...
  const navigation = [
    ...
    },
    {
      ...
      icon: Receipt,
      description: "Analisis Laporan Pengeluaran & Pendapatan Tanaman",
    ...
    //   href: "/pendaftaran",
    //   icon: ReceiptEuroIcon,
    //   description: "Pendaftaran Register",
    //   gradient: "from-white-500 to-purple-600",
    // },
    {
      name: "Pengaturan",
                    ...
                    >
                      <div
                        className={`p-2 rounded-xl transition-all duration-300 ${
                          isActive
                            ? getThemeClasses("bg-white/20", "!bg-white/40")
